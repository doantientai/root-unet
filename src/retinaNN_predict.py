...
print "Path experiment: " + path_experiment
...
# print("AVG value of layer R: ", np.average(orig_imgs[0,0,:,:]))
# print("AVG value of layer G: ", np.average(orig_imgs[0,1,:,:]))
# print("AVG value of layer B: ", np.average(orig_imgs[0,2,:,:]))
...
#     print("AVG value of layer R: ", np.average(orig_stripe[:,:,0]))
#     print("AVG value of layer G: ", np.average(orig_stripe[:,:,1]))
#     print("AVG value of layer B: ", np.average(orig_stripe[:,:,2]))
